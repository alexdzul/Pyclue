...
class AddKeyForm(QtWidgets.QDialog):
    ...
    def drawUI(self):
        ...
        self.txtEmail = QtWidgets.QLineEdit(self.gbInfo)
        self.txtEmail.setObjectName("txtEmail")
        self.gridLayout_gbInfo.addWidget(self.txtEmail, 1, 1, 1, 2)
        self.lblEmail = QtWidgets.QLabel(self.gbInfo)
        ...
        self.txtPassword = QtWidgets.QLineEdit(self.gbInfo)
        ...
        self.lblPassword = QtWidgets.QLabel(self.gbInfo)
        ...
        self.btnRandom = QtWidgets.QPushButton(self.gbInfo)
